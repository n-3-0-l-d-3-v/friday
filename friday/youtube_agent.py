...
from friday.config import REPO_PATH, YOUTUBE_API_KEY, GROQ_API_KEY, INDEX_PATH
...
def summarize_with_ai(metadata, transcript):
    ...
    prompt = f"""You are Friday, analyzing a YouTube video for a developer's knowledge base.
...
---
*Captured: {timestamp} | Channel: {metadata['channel']} | Friday*"""
