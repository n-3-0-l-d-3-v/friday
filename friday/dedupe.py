"""
Near-duplicate detection and merging (`friday dedupe`).
...
SAFETY: this is the only part of Friday that deletes notes, so it is DRY-RUN BY
...
from friday.index_store import load_index, remove_note
        ...
        try:
            if archive:
                ...
                header = (
                    ...
                    f"by friday dedupe. Original path: {label} -->\n"
                )
