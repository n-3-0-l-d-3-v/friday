...
def fetch_article(url):
    ...
    headers = {
        ...
        "User-Agent": "Friday-Knowledge-OS/1.0",
    }
...
def classify_article_with_ai(url, content, metadata):
    ...
    prompt = f"""
You are Friday, analyzing a technical article for a developer knowledge base.
...
"""
    ...
    try:
        ...
        from friday.classifier import normalize_domain, normalize_subdomain
...
---
*Captured: {timestamp} | Source: {metadata['site']} | Friday*
"""
