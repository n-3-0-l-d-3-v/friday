...
from friday.daily_log import finalize_log, generate_weekly_summary
...
def _run_curate():
    ...
    """
    from friday.curator import run_cycle
...
def main():
    ...
    if command == "finalize":
        ...
        print("Usage: python -m friday.tasks [finalize|rss|curate]")
