...
from friday.config import REPO_PATH, INDEX_PATH
...
from friday.git_sync import sync, build_commit_message
...
#
#             if classification.get("type") == "dsa" or source == "leetcode":
#                 print("  [Friday] DSA note detected — activating specialist agent...")
#                 enriched_data = analyze_dsa_note(text, classification, leetcode_data)
#                 if enriched_data:
#                     print(
#                         "  [Friday] DSA Agent: enriched with pattern="
...
#                 else:
#                     print("  [Friday] DSA Agent unavailable — using standard formatter")
