"""
Retention tools: spaced repetition (`friday review`) and self-testing (`friday quiz`).
...
`friday review` uses a simple SM-2-style ladder: each time you confirm you still
...
`friday quiz` turns your own notes into questions — useful before an interview.
"""
