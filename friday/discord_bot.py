...
async def send_response(channel, title, description, color=discord.Color.green()):
    ...
    embed.set_footer(text="Friday Knowledge OS")
...
@bot.event
async def on_ready():
    print(f"  [Discord] Friday bot online: {bot.user}")
...
async def on_message(message):
    ...
    try:
        ...
        # Regular text note
            ...
            from friday.orchestrator import process_single_note
...
def run_bot():
    if not DISCORD_BOT_TOKEN:
        ...
        return
    print("  [Discord] Starting Friday Discord bot...")
